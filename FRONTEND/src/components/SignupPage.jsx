  ...
  return (
    ...
    <div className="mx-auto my-8 flex w-full max-w-sm flex-col px-4">
      ...
      <label htmlFor="email" className="mb-1 inline-block text-gray-300">Email*</label>
        <input id="email" type="email" name='email' placeholder="Enter your email" className="mb-4 rounded-lg border bg-transparent px-3 py-2"/>
      <label htmlFor="username" className="mb-1 inline-block text-gray-300">Username*</label>
      <input id="username" name='username' type="text" placeholder="Enter your username" className="mb-4 rounded-lg border bg-transparent px-3 py-2"/>
      <label htmlFor="fullname"
        className="mb-1 inline-block text-gray-300">fullname*</label>
        <input id="fullname" name="fullname" type="text"
        placeholder="Enter your fullname" className="mb-4 rounded-lg border w-full bg-transparent px-3 py-2" />
      ...
      <label htmlFor="avatar"
        className="mb-1 inline-block text-gray-300">Avatar*</label>
...
export async function handleregister({ request }) {
  ...
  formPayload.append('fullname', formData.get('fullname'));
