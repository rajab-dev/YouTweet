...
function Recomendedvideos({suggestedvids}) {
        ...
        <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                ...
                <p className="mb-0.5 mt-2 text-sm text-gray-200">{video.owner.fullname}
                </p></Link>
                <p className="flex text-sm text-gray-200">{video.views?.length} Views · {timeAgo}</p>
              </div>
            </div>
          </div> 
       )
