...
import OtherpersonVideos from './OtherpersonVideos';
  ...
  <section class="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
    ...
    <div class="px-4 pb-4">
      ...
      <ul
        ...
        <button
            class="w-full border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff]">Videos</button></Link> </li>
        
        <li class="w-full">
        <Link to={`/channel/${userinfo?.channel?.username}/tweets`}>
        <button
            class="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Tweets</button></Link></li>
...
export default OtherPersonChannel